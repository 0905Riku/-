#ifndef WATCHCHECKGAME_H
#define WATCHCHECKGAME_H
...
namespace Ui {
class WatchCheckGame;
}

class WatchCheckGame : public QWidget
{
    Q_OBJECT
public:
...
public:
    explicit WatchCheckGame(QWidget *parent = nullptr);
